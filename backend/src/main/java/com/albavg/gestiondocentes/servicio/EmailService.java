...
public class EmailService {
    ...
    public void enviarResetPassword(String email, String nombre, String token) {
                        ...
                        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.08);overflow:hidden;">
                          ...
                          <tr>
                            <td style="padding:36px 40px;">
                              ...
                              <p style="margin:0 0 24px;font-size:0.95rem;color:#555;line-height:1.6;">
                                Hemos recibido una solicitud para restablecer tu contraseña en el <strong>Gestor de Profesores</strong>.<br>
                                Haz clic en el botón para crear una nueva contraseña. Si no lo solicitaste, ignora este correo.
                              </p>
                          ...
                          <tr>
                            <td style="padding:16px 40px;border-top:1px solid #eeeeee;background:#fafafa;">
                              <p style="margin:0;font-size:0.8rem;color:#aaa;">Este enlace expira en 24 horas.</p>
                            </td>
                          </tr>
                        </table>
                      </td>
        ...
        try {
            ...
            helper.setTo(email);
            helper.setSubject("Restablece tu contraseña - Gestor de Profesores");
